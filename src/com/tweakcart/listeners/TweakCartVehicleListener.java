...
public class TweakCartVehicleListener extends VehicleListener {
    ...
    private void parseSign(Sign sign, Minecart cart, Direction direction)
    {
        ...
        {
            StorageMinecart scart = (StorageMinecart) cart;
            ...
            for (int i = 0; i < lines.length; i++)
            {
                ...
                if (lines[i].toLowerCase().contains("collect items"))
                {
                    ...
                    ItemStack[] cartContent = scart.getInventory().getContents();
                    ...
                    if (!stateList.isEmpty())
                    {
                        ...
                        if (!(materials == null || materials.isEmpty()))
                        {
                            ...
                            scart.getInventory().setContents(cartContent);
                        }
                    }
                }
                else if (lines[i].toLowerCase().contains("deposit items"))
                {
                    ...
                    if (!stateList.isEmpty())
                    {
                        ...
                        if (!(materials == null || materials.isEmpty()))
                        {
                            ...
                            scart.getInventory().setContents(chestContent);
                        }
                    }
                }
                else
